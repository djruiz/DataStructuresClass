...
public class Int2DArray implements Int2DArrayADT {
    ...
    public void sortCol(){
        for(int i = 0; i < this.rows; i++){
            //System.out.println(Arrays.toString(this.getCol(i)));
            int[] colSorted = bubbleSort.sort(this.getCol(i));
            this.setCol(colSorted, i);
            //System.out.println(Arrays.toString(this.getCol(i)));
        }
    }
    public void sortrow(){
        for(int i = 0; i < this.rows; i++){
            //System.out.println(Arrays.toString(this.getCol(i)));
            bubbleSort.sort(this.getRow(i));
            //System.out.println(Arrays.toString(this.getRow(i)));
        }
    }
